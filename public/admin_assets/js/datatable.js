            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "language": {// language settings
                        ...
                        "metronicAjaxRequestGeneralError": "A kérés nem hajtható végre!",
                        // data tables spesific
                    ...
                    "ajax": {// define ajax settings
                        ...
                        "dataSrc": function (res) { // Manipulate the data returned from the server
                             ...
                             */
                            // csoportos műveletek: szerver által visszaadott adatok kezelése!!! 
                            if (res.customActionMessage.success) {
                                Metronic.alert({
                                    type: 'success',
                                    //icon: (res.customActionStatus == 'OK' ? 'check' : 'warning'),
                                    message: res.customActionMessage.success,
                                    container: tableWrapper,
                                    reset: false,
                                    place: 'prepend'
                                });
                            ...
                            if (res.customActionMessage.error) {
                                Metronic.alert({
                                    type: 'warning',
                                    //icon: (res.customActionStatus == 'OK' ? 'check' : 'warning'),
                                    message: res.customActionMessage.error,
                                    container: tableWrapper,
                                    reset: false,
                                    place: 'prepend'
                                });
