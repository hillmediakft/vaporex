...
//            "bStateSave": true, // save datatable state(pagination, sort, etc) in cookie.
        ...
        var tableWrapper = jQuery('#photo_category_wrapper');
    ...
    var deleteOnePhotoCategoryConfirm = function () {
...
$(document).ready(function () {
    ...
    Photo_category.init(); // init photo category page
});
