...
job oldal
**/
var Job_category = function () {

    var jobCategoryTable = function () {

        var table = $('#job_category');
		// begin first table
        ...
        var tableWrapper = jQuery('#job_category_wrapper');
	...
	var printTable = function () {
		$('#print_job_category').on('click', function(e){
		e.preventDefault();
		var divToPrint = document.getElementById("job");
...
$(document).ready(function() {    
	...
	Job_category.init(); // init job category page
});