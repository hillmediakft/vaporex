var referenceCategory_insert_update = function () {
    ...
    var handleValidation = function () {
        ...
        var form1 = $('#reference_category_form');
        ...
        form1.validate({
            ...
            rules: {
                reference_category_name_hu: {
                    required: true
                },
                reference_category_name_en: {
                    required: true
                }
            },
...
jQuery(document).ready(function () {
    ...
    referenceCategory_insert_update.init();
});
