...
<main class="main-content" >
    <div class="container">
        <div class="row">
            <?php include('system/site/view/termekek/tpl_sidebar_termekek.php'); ?> 
                        ...
                        <div class="col-md-6">
                            <div class="product-right animated" data-animation="bounceInUp">
                                ...
                                <div class="meta-list">
                                    ...
                                    <a href="termekek/kategoria/<?php echo Util::string_to_slug($product['product_category_name']) . '/' . $product['product_category_id']; ?>"><?php echo $product['product_category_name']; ?></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="product-image-left animated" data-animation="bounceInUp">
                                <div class="clearfix" id="image-block">
                                    <div>
                                        <ul class="slides">
                                            <li> <a class="magnific" href="<?php echo $product['product_photo']; ?>"> <img src="<?php echo $product['product_photo']; ?>" alt="<?php echo $product['product_title']; ?>"/></a> </li>
