...
<div id="iview">
    <?php foreach ($slider as $value) : ?>
        <div data-iview:thumbnail="<?php echo Util::thumb_path(Config::get('slider.upload_path') . $value['picture']); ?>" data-iview:image="<?php echo Config::get('slider.upload_path') . $value['picture']; ?>" data-iview:transition="block-drop-random" >
            <div class="container">
                    ...
                    <li >
                        <div class="product-container">
                            <div class="product-image"> 
                                <a href="termekek/<?php echo Util::string_to_slug($value['product_title']) . '/' . $value['product_id'];?>"> 
                                    <img class="" src="<?php echo Util::thumb_path($value['product_photo']); ?>"  alt="img"/>
                                </a> 
                            </div>
                            <div class="product-bottom"> 
                                <a class="product-name"  href="termekek/<?php echo Util::string_to_slug($value['product_title']) . '/' . $value['product_id'];?>">
                                ...
                                <div class="btn-group"> <a href="termekek/<?php echo Util::string_to_slug($value['product_title']) . '/' . $value['product_id'];?>" class="btn btn-primary ">Részletek </a> </div>
                            </div>
                        </div>
                    </li>
                    <?php
