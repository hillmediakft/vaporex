                ...
                <div class="social-box">
                    <ul class="social-links">
                        ...
                        <?php if ($logged_in === true) { ?>
                            <li><span><a href="profil"><i class="fa fa-user"></i> <?php echo Session::get('user_site_name'); ?></a>&nbsp; | </span><a href="felhasznalok/kijelentkezes"><i class="fa fa-sign-out"></i> Kijelentkezés</a></li>
                        <?php } else { ?>
                            <li><a href="javascript:void();" data-toggle="modal" data-target="#modal_login"><i class="fa fa-sign-in"></i> Bejelentkezés</a>
                            </li>
                        <?php } ?>	
                    </ul>
                </div>
