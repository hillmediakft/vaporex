                ...
                <div class="row">
                            ...
                            <div class="person-info">
                                ...
                                <div class="person-name">
                                    ...
                                    <p>06-20-255-6835, 06-30-986-2473<br>
                                        <?php echo Util::safe_mailto('megrendeles@vaporex.hu'); ?></p>
                                </div>
                            </div>  
                    ...
                    <div class="col-md-5">
                        <div data-animation="fadeInRight" class="full-width-right animated ">
                            <form id="contactform" class="contactForm2" data-animation="bounceInUp" ction="<?php echo $this->registry->site_url; ?>kapcsolat">
