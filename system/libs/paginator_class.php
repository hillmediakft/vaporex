...
class Paginator {
    ...
    public function page_links($uri_path) {
        ...
        if ($lastpage > 1) {
            ...
            // A <i class="fa fa-angle-double-left"></i> linkje
            if ($this->page_id > 1) {
                $paginate.= '<li><a href="' . $path . $this->pagename . '=' . $prev . '"><i class="fa fa-angle-double-left"></i></a></li>';
            } else {
                $paginate.= '<li class="inactive"><span><i class="fa fa-angle-double-left"></i></span></li>';
            }
            // Oldalak	
            ...
            // A <i class="fa fa-angle-double-right"></i> linkje
            if ($this->page_id < $counter - 1) {
                $paginate.= '<li><a href="' . $path . $this->pagename . '=' . $next . '"><i class="fa fa-angle-double-right"></i></a></li>';
            } else {
                $paginate.= '<li class="inactive"><span><i class="fa fa-angle-double-right"></i></span></li>';
            }
