            ...
            <div class="col-md-12">
                ...
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption"><i class="fa fa-cogs"></i>Hírlevélre feliratkozottak</div>
                        <div class="actions">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li>
                                        <a href="#" id="print_subscribers"><i class="fa fa-print"></i> Nyomtat </a>
                                    </li>
                                    <li>
                                        <a href="#" id="export_subscribers"><i class="fa fa-file-excel-o"></i> Export CSV </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="table-container">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="subscribers_table">
                                <thead>
                                    ...
                                    <tr role="row" class="filter hidden-print">
                                        <td>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <select name="search_county" id="search_county" class="form-control form-filter input-sm">
                                                <option value="">-- Válasszon --</option>
