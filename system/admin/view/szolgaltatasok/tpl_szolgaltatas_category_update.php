                                ...
                                <div class="col-md-12">						
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 400px; height: 300px;"><img src="<?php echo Config::get('szolgaltatascategoryphoto.upload_path') . $category_content[0]['szolgaltatas_list_photo']; ?>" alt=""/></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="szolgaltatas_list_name" id="szolgaltatas_list_name" value="<?php echo $category_content[0]['szolgaltatas_list_name'] ?>" class="form-control input-xlarge" />
                                    </div>

                                    <!-- régi kép neve-->
                                    <input type="hidden" name="old_img" value="<?php echo $category_content[0]['szolgaltatas_list_photo']; ?>">
                                    <!-- régi kategória neve-->
                                    <input type="hidden" name="old_category" value="<?php echo $category_content[0]['szolgaltatas_list_name']; ?>">
