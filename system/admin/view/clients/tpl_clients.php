                                ...
                                <tbody>
                                    <?php foreach ($all_client as $value) { ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td style="width:155px;"><img src="<?php echo (!empty($value['client_photo'])) ? $value['client_photo'] : 'uploads/crew_photo/crew_placeholder.png';?>"/></td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-right">
                                                            ...
                                                            <?php if ((Session::get('user_role_id') < 3)) { ?>	
                                                                <li><a href="<?php echo $this->registry->site_url . 'clients/update_client/' . $value['client_id']; ?>"><i class="fa fa-pencil"></i> Szerkeszt</a></li>
                                                            <?php }; ?>

                                                            <?php if ((Session::get('user_role_id') < 3)) { ?>	
                                                                <li><a href="<?php echo $this->registry->site_url . 'clients/delete_client/' . $value['client_id']; ?>" id="delete_client_<?php echo $value['client_id']; ?>"> <i class="fa fa-trash"></i> Töröl</a></li>
                                                            <?php }; ?>
