                            ...
                            <div class="row">	
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_title" id="product_title" placeholder="" class="form-control input-xlarge" />
                                    </div>
                                    <!-- MUNKA LEÍRÁSA -->	
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_price" id="product_price" placeholder="" class="form-control input-xlarge" />
                                    </div>
