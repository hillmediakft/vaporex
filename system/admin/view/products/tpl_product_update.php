                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row">	
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" id="old_img"  value="<?php echo $actual_product[0]['product_photo']; ?>" name="old_img">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php // echo Config::get('productphoto.upload_path') . $actual_product[0]['product_photo'];  ?>" alt=""/></div>
                                    ...
                                    <!-- TERMÉK MEGNEVEZÉSE -->	
                                    <div class="form-group">
                                        <label for="product_title" class="control-label">Megnevezés (magyar)<span class="required">*</span></label>
                                        <input type="text" name="product_title" id="product_title" class="form-control input-xlarge" value="<?php echo $actual_product[0]['product_title']; ?>"/>
                                    </div>
                                    <!-- MUNKA LEÍRÁSA -->	
                                    <div class="form-group">
                                        <label for="product_description" class="control-label">Leírás (magyar)</label>
                                        <textarea name="product_description" id="product_description" placeholder="" class="form-control input-xlarge" rows="10"><?php echo $actual_product[0]['product_description']; ?></textarea>
                                        <?php if (isset($ckeditor) && $ckeditor === true) { ?>
                                            <script type="text/javascript">
                                                //CKEDITOR.replace( 'product_description' );
                                                CKEDITOR.replace('product_description', {customConfig: 'config.js'});
                                            </script>
                                        <?php } ?>										
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="product_category_id" class="form-control input-xlarge">
                                            ...
                                            <?php foreach ($product_category_list_with_path as $value) { ?>
                                                <option value="<?php echo $value['cat_id']; ?>" <?php echo ($actual_product[0]['product_category_id'] == $value['cat_id']) ? 'selected' : ''; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_price" id="product_price" value="<?php echo $actual_product[0]['product_price']; ?>" class="form-control input-xlarge" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="product_tax" class="form-control input-xlarge">
                                            <option value="27" <?php echo ($actual_product[0]['product_tax'] == 27) ? 'selected' : ''; ?>>27%</option>
                                            <option value="18" <?php echo ($actual_product[0]['product_tax'] == 18) ? 'selected' : ''; ?>>18%</option>
                                            <option value="5" <?php echo ($actual_product[0]['product_tax'] == 5) ? 'selected' : ''; ?>>5%</option>
                                            <option value="0" <?php echo ($actual_product[0]['product_tax'] == 0) ? 'selected' : ''; ?>>0%</option>
                                        </select>
                                    </div>  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="product_status" class="form-control input-xlarge">
                                            <option value="0" <?php echo ($actual_product[0]['product_status'] == 0) ? 'selected' : ''; ?>>Inaktív</option>
                                            <option value="1" <?php echo ($actual_product[0]['product_status'] == 1) ? 'selected' : ''; ?>>Aktív</option>
