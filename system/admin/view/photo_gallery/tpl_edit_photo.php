                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data" id="edit_photo">	
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                <div class="fileupload-new thumbnail" style="width: 400px; height: 300px;"><img src="<?php echo $photo[0]['photo_filename']; ?>" /></div>
                                        ...
                                        <div class="col-md-6">						
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php foreach ($category_list as $value) { ?>
                                                        <option value="<?php echo $value['id']; ?>" <?php echo ($photo[0]['photo_category'] == $value['id']) ? 'selected' : ''; ?>><?php echo $value['category_name']; ?></option>
                                                    <?php } ?>    
