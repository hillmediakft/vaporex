                            ...
                            <div class="col-md-12">						
                                <form action="" method="POST" id="category_update_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="category_name" id="category_name" value="<?php echo $category_content[0]['category_name'] ?>" class="form-control input-xlarge" />
                                    </div>

                                    <!-- régi kategória neve-->
                                    <input type="hidden" name="old_category" value="<?php echo $category_content[0]['category_name']; ?>">
