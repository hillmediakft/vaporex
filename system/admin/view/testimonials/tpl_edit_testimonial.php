            ...
            <div class="col-md-12">
                ...
                <div class="portlet">
                    ...
                    <div class="portlet-body">
                        ...
                        <h2 class='cim1'><?php echo $data_arr[0]['name']; ?> véleményének szerkesztése</h2>
                        <br />
                        <form action='' name='update_testimonial_form' id='update_testimonial_form' method='POST'>
                            ...
                            <div class="form-group">
                                <label for="testimonial_title">Szerep</label>	
                            ...
                            <div class="form-group">
                                ...
                                <textarea name='testimonial_text' class='form-control'><?php echo $data_arr[0]['text'] ?></textarea>
                            </div>
