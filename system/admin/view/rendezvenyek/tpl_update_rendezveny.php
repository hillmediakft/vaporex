    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li><span>Rendezvény szerkesztése</span></li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" method="POST" id="update_rendezveny" enctype="multipart/form-data">	
                                    ...
                                    <div class="col-md-12">						
                                        ...
                                        <div class="form-group">
                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                <div class="fileupload-new thumbnail" style="width: 400px; height: 300px;"><img src="<?php echo Config::get('rendezvenyphoto.upload_path') . $actual_rendezveny[0]['rendezveny_photo']; ?>" alt=""/></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="rendezveny_title" id="rendezveny_title" value="<?php echo $actual_rendezveny[0]['rendezveny_title']; ?>" class="form-control input-xlarge" />
                                        </div>
                                        <!-- RENDEZVÉNY LEÍRÁSA -->	
                                        <div class="form-group">
                                            <label for="rendezveny_description" class="control-label">Leírás</label>
                                            <textarea name="rendezveny_description" id="rendezveny_description" class="form-control input-xlarge" rows="10"><?php echo $actual_rendezveny[0]['rendezveny_description']; ?></textarea>
                                        </div>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <select name="rendezveny_county_id" id="county_select" class="form-control input-xlarge">
                                                        ...
                                                        <?php foreach ($county_list as $value) { ?>
                                                            <option value="<?php echo $value['county_id']; ?>"
                                                                    <?php echo ($value['county_id'] == $actual_rendezveny[0]['rendezveny_county_id'] ? 'selected' : ''); ?>><?php echo $value['county_name']; ?></option>
                                                                <?php } ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group" id="city_div" style="<?php echo ($budapest == true) ? 'display:none;' : ''; ?>">
                                                    ...
                                                    <select name="rendezveny_city_id" class="form-control input-xlarge">
                                                        <?php foreach ($city_list as $value) { ?>
                                                            <option value="<?php echo $value['city_id']; ?>" <?php echo ($value['city_id'] == $actual_rendezveny[0]['rendezveny_city_id'] ? 'selected' : ''); ?>><?php echo $value['city_name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                <!-- KERÜLET MEGADÁSA -->	
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="rendezveny_location" id="rendezveny_location" value="<?php echo $actual_rendezveny[0]['rendezveny_location']; ?>" class="form-control input-xlarge" />
                                                </div>
                                                <!-- HELYSZÍN CÍME -->	
                                                <div class="form-group">
                                                    <label for="rendezveny_address" class="control-label">Rendezvény címe</label>
                                                    <input type="text" name="rendezveny_address" id="rendezveny_address" value="<?php echo $actual_rendezveny[0]['rendezveny_address']; ?>" class="form-control input-xlarge" />
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="rendezveny_location_lat_lng" id="rendezveny_location_lat_lng" value="<?php echo (isset($actual_rendezveny[0]['rendezveny_location_lat']) && isset($actual_rendezveny[0]['rendezveny_location_lng'])) ? (implode(", ", array($actual_rendezveny[0]['rendezveny_location_lat'], $actual_rendezveny[0]['rendezveny_location_lng']))) : ''; ?>" class="form-control input-xlarge" />
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="rendezveny_directions" id="rendezveny_directions" class="form-control input-xlarge" rows="10"><?php echo $actual_rendezveny[0]['rendezveny_directions']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-10">
                                                <select multiple="multiple" class="multi-select" id="rendezveny_szolgaltatasok" name="rendezveny_szolgaltatasok[]">
                                                    <?php foreach ($szolgaltatasok_list as $value) { ?>
                                                        <?php $jatekok = ($actual_rendezveny[0]['rendezveny_szolgaltatasok'] == null) ? '[]' : $actual_rendezveny[0]['rendezveny_szolgaltatasok'];?>
														<option value="<?php echo $value['szolgaltatas_id']; ?>"<?php echo (in_array($value['szolgaltatas_id'], json_decode($jatekok)) ? 'selected' : ''); ?>><?php echo $value['szolgaltatas_title']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>   
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="rendezveny_facebook_site_id" class="form-control input-xlarge">
                                                ...
                                                <?php foreach ($facebook_site_list as $value) { ?>
                                                    <option value="<?php echo $value['facebook_site_id']; ?>"
                                                            <?php echo ($value['facebook_site_id'] == $actual_rendezveny[0]['rendezveny_facebook_site_id'] ? 'selected' : ''); ?>><?php echo $value['facebook_site_name']; ?></option>
                                                        <?php } ?>
                                            </select>
                                        </div>	
                                        ...
                                        <div class="row">
                                            <div class='col-sm-6'>
                                                <div class="form-group">
                                                    ...
                                                    <div class='input-group date datetimepicker'>
                                                        <input type='text' class="form-control" name="rendezveny_start_timestamp" id="rendezveny_start_timestamp" value="<?php echo (empty($actual_rendezveny[0]['rendezveny_start_timestamp'])) ? '' : date('Y-m-d H:i', $actual_rendezveny[0]['rendezveny_start_timestamp']); ?>"/>
                                            ...
                                            <div class='col-sm-6'>
                                                <div class="form-group">
                                                    ...
                                                    <div class='input-group date datetimepicker'>
                                                        <input type='text' class="form-control" name="rendezveny_expiry_timestamp" id="rendezveny_expiry_timestamp" value="<?php echo (empty($actual_rendezveny[0]['rendezveny_expiry_timestamp'])) ? '' : date('Y-m-d H:i', $actual_rendezveny[0]['rendezveny_expiry_timestamp']); ?>"/>
                                                        <span class="input-group-addon">
                                                            <span class="glyphicon glyphicon-calendar"></span>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="rendezveny_status" class="form-control input-xlarge">
                                                <option value="1" <?php echo ($actual_rendezveny[0]['rendezveny_status'] == 1) ? 'selected' : ''; ?>>Aktív</option>
                                                <option value="0" <?php echo ($actual_rendezveny[0]['rendezveny_status'] == 0) ? 'selected' : ''; ?>>Inaktív</option>
                                            </select>
                                        </div>

                                        <!-- régi kép neve-->
                                        <input type="hidden" name="old_img" value="<?php echo $actual_rendezveny[0]['rendezveny_photo']; ?>">
                                        <button class="btn green btn-sm" type="submit"><i class="fa fa-check"></i> Mentés</button>
                                    </div>
                                </div>	
                            </div> <!-- END FORM BODY -->
