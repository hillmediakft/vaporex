<div class="page-content">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li>
				<a href="admin/document">Blog</a>
				<i class="fa fa-angle-right"></i>
			</li>
			<li><a href="admin/document/category">Kategóriák</a></li>
		</ul>
	</div>
				...
				<div class="portlet">
					...
					<div class="portlet-body">
						...
						<table class="table table-striped table-bordered table-hover" id="document_category">
							...
							<tbody>
							<?php foreach($this->all_document_category as $value) { ?>
								<tr data-id="<?php echo $value['category_id'];?>">
									...
									<td><?php echo $value['category_name'];?></td>
										...
										foreach($this->category_counter as $v) {
											if($value['category_id'] == $v['document_category']) {
												$counter++;
											}
										}
										?>
