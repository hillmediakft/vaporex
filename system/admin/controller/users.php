...
class Users extends Controller {
    ...
    public function index() {
        ...
        $this->check_access('menu_users_list');
...
//$this->view->debug(true);	
    ...
    public function new_user() {
        $this->check_access('menu_insert_user');
    ...
    public function edit_roles() {
        ...
        $role_id = $this->registry->params['id'];
        
        if (isset($_POST['submit_edit_roles'])) {
    ...
    public function delete_user() {
        ...
        $this->check_access('action_delete_user');
