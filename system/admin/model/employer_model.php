...
class Employer_model extends Model {
	...
	public function insert_employer()
	{
		...
		if($error_counter == 0) {
			...
			$data['employer_name'] = $data['employer_name'];
			$data['employer_address'] = $data['employer_address'];
			$data['employer_contact_person'] = $data['employer_contact_person'];
			$data['employer_contact_tel'] = $data['employer_contact_tel'];
			$data['employer_contact_email'] = $data['employer_contact_email'];
			$data['employer_remark'] = $data['employer_remark'];
